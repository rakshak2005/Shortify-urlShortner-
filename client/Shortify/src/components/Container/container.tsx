      ...
      <div className="max-w-4xl mx-auto text-center space-y-6 mb-16">
        ...
        <form onSubmit={handleSubmit} className="relative max-w-2xl mx-auto mt-10">
          <div className="relative group">
            ...
            <input
              type="text"
              id="longUrl"                  // ✅ FIX ADDED
              name="longUrl"                // ✅ FIX ADDED
              autoComplete="url"            // ✅ optional but recommended
          ...
          <div className="p-8 border-b border-slate-800 flex justify-between items-center">
            ...
            <div className="flex gap-2">
               <div className="relative">
                 ...
                 <input
                   type="text"
                   id="searchLinks"          // ✅ FIX ADDED
                   name="searchLinks"        // ✅ FIX ADDED
                   className="bg-slate-800/40 border border-slate-700 rounded-lg pl-8 pr-4 py-2 text-xs focus:outline-none"
